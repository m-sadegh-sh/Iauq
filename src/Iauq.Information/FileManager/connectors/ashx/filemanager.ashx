...
public class filemanager : IHttpHandler
{
    ...
    public string[] imgExtensions = new[] {".jpg", ".png", ".jpeg", ".gif", ".bmp"};
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        if (!context.Request.IsAuthenticated ||
            !webHelper.IsInRole(context.User.Identity.Name, "Administrators", "Moderators", "Editors"))
        {
            //context.Response.StatusCode = (int) HttpStatusCode.Forbidden;
            context.Response.ContentType = "plain/text";
            context.Response.ContentEncoding = Encoding.UTF8;

            context.Response.Write(ForbiddenRequest());
            return;
        }
        ...
        switch (context.Request["mode"])
        {
            ...
            case "download":
                ...
                context.Response.AddHeader("Content-Disposition",
                                           "attachment; filename=" + context.Server.UrlPathEncode(fi.Name));
    ...
    private string ForbiddenRequest()
    {
        ...
        sb.AppendLine("{");
        sb.AppendLine("\"Error\": \"لطفا ابتدا وارد سیستم شوید.\",");
    ...
    private string Rename(string path, string newName)
    {
        ...
        if ((attr & FileAttributes.Directory) == FileAttributes.Directory)
        {
            ...
            sb.AppendLine("\"New Path\": \"" +
                          fileInfo2.FullName.Replace(HttpRuntime.AppDomainAppPath, "/").Replace(
